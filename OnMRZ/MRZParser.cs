    ...
    public static class MrzParser
    {
        ...
        private static DateTime ParseDateOfBirth(string mrz)
        {
            var dob = new DateTime(
                int.Parse(DateTime.Now.Year.ToString().Substring(0, 2) + mrz.Substring(13 + 44, 2)),
                int.Parse(mrz.Substring(15 + 44, 2)),
        ...
        /// </seealso>
        private static string GetCheckDigit(string icaoPassportNumber)
        {
            ...
            {
                total += CheckDigitArray[dig] * multiplier;
                switch (multiplier)
                {
